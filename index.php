...
define('PG_REQUEST_URL', 'https://secure.dasshpe.com/crm/jsp/paymentrequest');
define('PG_RESPONSE_URL', 'https://secure.dasshpe.com/crm/jsp/response.jsp');
define('PG_RESPONSE_MODE', 'SALE');
define('PG_SALT', 'XXXXXXXXXXXXXXXXX'); //replace your SALT provided by DasshPe with XXXXXXXXXXXXXXXXX
define('PG_PAY_ID', 'XXXXXXXXXXXXXXXXX'); //replace your PAY_ID provided by DasshPe with XXXXXXXXXXXXXXXXX

if($_REQUEST){
$pg_transaction = new PGModule;
...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .signupbutton{background-color:#5469d4;border:1px solid #5469d4;width:40%;height:35px;font:bold 14px Tahoma;text-align:center;color:#fff;cursor:pointer;border-radius:5px}
...
<body>
    <div class="new">
        <form action="" method="post" action="<?php echo PG_REQUEST_URL; ?>">
            <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="gradientbg">
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="MERCHANTNAME" class="signuptextfield" value="DasshPe Demo" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="ORDER_ID" class="signuptextfield" value="<?php echo 'DasshPe'.date('dmyHi')?>" autocomplete="off" />
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_NAME" class="signuptextfield" value="DasshPe PG DEMO" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_STREET_ADDRESS1" class="signuptextfield" value="C-94, Saraswati Kunj" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_ZIP" value="122002" class="signuptextfield" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_EMAIL" class="signuptextfield" value="user@demo.in" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
